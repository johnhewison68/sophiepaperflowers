...
export default function Page() {
  return (
    <>
      <div className="animate-fade-in flex flex-col md:flex-row-reverse items-center p-8">
        ...
        <div className=" text-justify text-lg font-[540]">
          <h1>Crafting Authentic Paper Flowers</h1>
          <h2>by Sophie Longhurst</h2>
          <p className="mt-5">

            A Journey into Elegant Paper Flower Art.

            <br />Step into a world where delicate petals unfurl from paper and imagination, and time seems to slow with each thoughtful fold.

            <br /><br />Rooted in an ancient tradition dating back to 100 BC, this beautiful guide to paper flower crafting invites you to rediscover the quiet magic of handmade beauty. With graceful step-by-step instructions and exquisite illustrations, every project becomes a meditative escape.
            <br />Perfect for unwinding, creating, and connecting with nature in the most enchanting way.
            <br />
